var xiaomi = {
	...
	ajaxFun() {
		let test;
		// 第一步:获取LNLHttpRequest对象
		if (window.LNLHttpRequest) {
			test = new LNLHttpRequest();
	...
	// 结算条
	cartBar() {
		let recommendTitle = document.getElementsByClassName('LN-recommend-title')[0].getBoundingClientRect().top;
